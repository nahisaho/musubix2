...
**CLI**: `npx musubix2 codegen <name> [--type class|interface|function|...]`
...
**CLI**: `npx musubix2 scaffold <project|package|skill> <name>`
...
**CLI**: `npx musubix2 learn analyze <path>`
...
**CLI**: `npx musubix2 workflow status <entity>`
